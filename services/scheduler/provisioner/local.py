...
_MSG = "LocalMacProvisioner will be implemented for dev/self-host later."


class LocalMacProvisioner(MacProvisioner):
    """Local self-hosted tart driver placeholder for developer machines."""
