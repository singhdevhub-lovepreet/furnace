...
class Settings(BaseSettings):
    ...
    aws_availability_zone: str = Field(default="us-east-1a")
    aws_mac_instance_type: str = Field(default="mac2.metal")
    aws_mac_ami_id: str = Field(default="")
    aws_ssh_key_name: str = Field(default="")
    aws_ssh_key_path: str = Field(default="")
    tart_golden_vm: str = Field(default="raven-golden")
    tart_vms_per_host: int = Field(default=2, ge=1)
